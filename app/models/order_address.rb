class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :postal_code, format: {with: /\A[0-9]{3}-[0-9]{4}\z/, allow_blank: true, message: "is invalid. Enter it as follows (e.g. 123-4567)"}
    validates :prefecture_id, numericality: { other_than: 0, message: "can't be blank" }
    validates :telephone_number, numericality: { allow_blank: true, message: "is invalid. Input only number"}, length: { in: 10..11, allow_blank: true, message: "is too short"}
  end
